...
//  
  ...
  myMotorRight->step(200, FORWARD, MICROSTEP); 
  myMotorRight->step(200, BACKWARD, MICROSTEP);
  myMotorLeft->step(200, FORWARD, MICROSTEP); 
  myMotorLeft->step(200, BACKWARD, MICROSTEP);
}
